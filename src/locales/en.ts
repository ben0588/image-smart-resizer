...
export const en = {
  ...
  controls: {
    ...
    watermarkUpload: "Upload or drop watermark image",
    watermarkRemove: "Remove watermark",
    watermarkQuickPosition: "Quick Position",
    watermarkAutoMargin: "Auto Margin",
    watermarkSize: "Size",
    watermarkOpacity: "Opacity",
    watermarkTopLeft: "Top Left",
    watermarkTopCenter: "Top Center",
    watermarkTopRight: "Top Right",
    watermarkCenterLeft: "Center Left",
    watermarkCenter: "Center",
    watermarkCenterRight: "Center Right",
    watermarkBottomLeft: "Bottom Left",
    watermarkBottomCenter: "Bottom Center",
...
<div class="space-y-6 text-slate-600">
  ...
  seo: {
    title:
      "Free Online Image Resizer & Converter (Privacy-First) | Image Smart Resizer",
    description:
      "A privacy-first, high-quality online image resizer and converter. Batch resize images, convert SVG to PNG, and crop photos directly in your browser. No server uploads required—your photos stay on your device. Powered by Pica for professional-grade results.",
    features:
      "free image resizer, batch image converter, online photo editor, SVG to PNG converter, high quality image resizing, resize images without uploading, privacy-focused image tool, crop and rotate images, make favicon, convert WebP to JPG, client-side image processing, Pica algorithm",
  },
  ...
  canvasPermission: {
    ...
    description1:
      "To protect your privacy, we process images <strong>locally</strong> without uploading to a server.",
    description2:
      "However, your browser has flagged this as potentially risky. Please temporarily grant permission for this site.",
    chooseBrowser: "How to fix? Please select your browser:",
    braveTitle: "Brave Browser (Most Common)",
    braveStep1:
      'Click the <span class="font-bold text-orange-600">Lion icon</span> on the right side of the address bar.',
    braveStep2: "Turn off the top switch (Shields DOWN).",
    braveStep3:
      "Or: Click Advanced View and set &quot;Block fingerprinting&quot; to Disabled.",
    firefoxTitle: "Firefox",
    firefoxStep1:
      'Click the <span class="font-bold text-purple-600">Shield icon</span> on the left side of the address bar.',
    firefoxStep2: "Turn off &quot;Enhanced Tracking Protection&quot;.",
    firefoxStep3:
      "If you don't want to turn it off completely, go to settings and uncheck &quot;Fingerprinters&quot;.",
    safariTitle: "Safari",
    ...
    chromeEdgeDesc:
      "Chrome usually doesn't block this. If you see this message, it's usually because of privacy extensions (e.g., <strong>Privacy Badger</strong>, <strong>CanvasBlocker</strong>).",
