...
export const ko: Translation = {
  ...
  controls: {
    ...
    cancel: "취소",
    // 워터마크
    watermarkOverlay: "워터마크",
    watermarkUpload: "워터마크 이미지 업로드 또는 드롭",
    watermarkRemove: "워터마크 제거",
    watermarkQuickPosition: "빠른 위치",
    watermarkAutoMargin: "자동 여백",
    watermarkSize: "크기",
    watermarkOpacity: "투명도",
    watermarkTopLeft: "왼쪽 상단",
    watermarkTopCenter: "중앙 상단",
    watermarkTopRight: "오른쪽 상단",
    watermarkCenterLeft: "왼쪽 중앙",
    watermarkCenter: "중앙",
    watermarkCenterRight: "오른쪽 중앙",
    watermarkBottomLeft: "왼쪽 하단",
    watermarkBottomCenter: "중앙 하단",
    watermarkBottomRight: "오른쪽 하단",
  },
  ...
  footer: {
    ...
    footerQuestions:
      "궁금한 점이 있으신가요? GitHub 또는 이메일로 문의해 주세요.",
    privacyText: `
<div class="space-y-6 text-slate-600">
  ...
  seo: {
    title:
      "무료 온라인 이미지 크기 조절 및 변환 도구 (업로드 불필요) | Image Smart Resizer",
    description:
      "개인정보를 최우선으로 하는 무료 온라인 이미지 일괄 리사이징 도구입니다. Pica 고화질 알고리즘을 사용하여 JPG, PNG, WebP, ICO 변환 및 SVG의 PNG 변환(파비콘 제작)을 지원합니다. 모든 처리는 브라우저에서만 이루어지며 서버로 전송되지 않아 데이터가 안전합니다.",
    features:
      "온라인 이미지 리사이징, 이미지 크기 조절, 이미지 일괄 변환, 이미지 포맷 변환, 해상도 조절, 이미지 압축 도구, SVG PNG 변환, 파비콘 만들기, 이미지 자르기, 이미지 회전, WebP JPG 변환, Pica 알고리즘, 고화질 리사이징, 개인정보 보호, 업로드 불필요, 서버 전송 없음",
  },
  ...
  canvasPermission: {
    ...
    description1:
      "개인정보 보호를 위해 이미지는 서버에 업로드하지 않고 <strong>로컬</strong>에서 처리됩니다.",
    description2:
      "하지만 브라우저에서 이 동작을 위험한 것으로 판단했으므로, 일시적으로 이 사이트의 권한을 허용해 주세요.",
    chooseBrowser: "해결 방법: 사용 중인 브라우저를 선택하세요.",
    braveTitle: "Brave 브라우저 (권장)",
    braveStep1:
      '주소창 오른쪽의 <span class="font-bold text-orange-600">사자 아이콘</span>을 클릭합니다.',
    braveStep2: "상단 스위치를 끕니다 (Shields DOWN).",
    braveStep3:
      "또는: Advanced View를 클릭하고 &quot;Block fingerprinting&quot;을 Disabled로 변경합니다.",
    firefoxTitle: "Firefox",
    firefoxStep1:
      '주소창 왼쪽의 <span class="font-bold text-purple-600">방패 아이콘</span>을 클릭합니다.',
    firefoxStep2: "「항상 강화된 추적 방지」를 끕니다.",
    firefoxStep3:
      "완전히 끄고 싶지 않다면 설정에서 「핑거프린터 (Fingerprinters)」 체크를 해제하세요.",
    safariTitle: "Safari",
    ...
    chromeEdgeDesc:
      "Chrome은 보통 차단하지 않습니다. 이 메시지가 표시된다면 보통 보안 확장 프로그램(예: <strong>Privacy Badger</strong>, <strong>CanvasBlocker</strong>) 때문입니다.",
    chromeEdgeAction:
      "이러한 확장 프로그램을 일시 중지한 후 다시 시도해 보세요.",
    cancel: "취소",
    retry: "설정 완료, 다시 시도",
  },
  ...
  appIcon: {
    ...
    appIconMode: "앱 아이콘",
    selectPlatform: "대상 플랫폼 선택",
    selectPlatformDesc: "아이콘을 생성할 플랫폼을 선택하세요",
    sizes: "가지 크기",
    totalOutput: "생성 수",
    files: "개 파일",
    organizedIn: "폴더로 분류",
    folders: "개 폴더",
    noPlatform: "최소 하나의 플랫폼을 선택하세요",
    noPlatformPreview: "먼저 플랫폼을 선택하세요",
    sourceImage: "소스 이미지",
    outputReadOnly: "각 플랫폼 출력 크기 미리보기 (읽기 전용)",
    usage: "용도",
    status: "상태",
    generateAndDownload: "아이콘 생성 및 다운로드",
    qualityHint:
      "이 모드는 100% 최고 품질로 출력하며, 압축 없이 선명한 아이콘을 보장합니다.",
    // iOS 설명
    descIosAppStore: "App Store 메인 아이콘, 투명도 불가, sRGB",
    descIosIphone3x: "iPhone 홈 화면 @3x",
    descIosIphone2x: "iPhone 홈 화면 @2x",
    descIosIpadPro2x: "iPad Pro 홈 화면 @2x",
    descIosIpad2x: "iPad 홈 화면 @2x",
    descIosSettings3x: "시스템 설정 @3x",
    descIosSettings2x: "시스템 설정 @2x",
    descIosNotification3x: "알림 아이콘 @3x",
    descIosNotification2x: "알림 아이콘 @2x",
    // Android 설명
    descAndroidPlayStore: "Google Play 스토어 아이콘, 32-bit PNG, 최대 1MB",
    descAndroidAdaptive: "적응형 아이콘 Full Asset",
    descAndroidXxxhdpi: "런처 xxxhdpi",
    descAndroidXxhdpi: "런처 xxhdpi",
    descAndroidXhdpi: "런처 xhdpi",
    descAndroidHdpi: "런처 hdpi",
    descAndroidMdpi: "런처 mdpi",
    descAndroidNotification: "알림 아이콘",
    // Web 설명
    descWebFavicon32: "브라우저 탭 아이콘",
    descWebFavicon16: "브라우저 탭 아이콘 (소)",
    descWebFaviconIco: "Favicon .ico (구형 브라우저 호환)",
    descWebAppleTouchIcon: "iOS 홈 화면 추가 시 사용",
    descWebPwa512: "PWA 스플래시 화면용",
    descWebPwa192: "PWA 설치 아이콘",
    descWebOgImage: "FB/Line 소셜 공유 미리보기 (1.91:1)",
  },
};
