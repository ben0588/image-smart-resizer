...
export const zhTW: Translation = {
  ...
  controls: {
    ...
    cancel: "取消",
    // 浮水印
    watermarkOverlay: "浮水印疊加",
    watermarkUpload: "上傳或拖放浮水印圖片",
    watermarkRemove: "移除浮水印",
    watermarkQuickPosition: "快速定位",
    watermarkAutoMargin: "自動邊距",
    watermarkSize: "大小",
...
<div class="space-y-6 text-slate-600">
  ...
  // SEO
  seo: {
    title: "免費線上圖片縮放與轉檔工具 (免上傳) | Image Smart Resizer",
    description:
      "免費且重視隱私的線上批次圖片縮放工具。採用 Pica 高畫質演算法，支援 JPG、PNG、WebP、ICO 互轉及 SVG 轉 PNG (Favicon 製作)。所有處理皆在瀏覽器端完成，圖片無需上傳伺服器，確保資料絕對安全。",
    features:
      "線上圖片縮放, 批次縮圖, 圖片轉檔, 照片解析度調整, 圖片壓縮工具, SVG 轉 PNG, 製作 Favicon, 圖片裁切, 圖片旋轉, WebP 轉 JPG, Pica 演算法, 高畫質縮圖, 隱私保護, 免上傳, 客戶端處理",
  },
  ...
  canvasPermission: {
    ...
    braveStep1:
      '點擊網址列右側的 <span class="font-bold text-orange-600">獅子頭圖示</span>。',
    braveStep2: "關閉上方的開關 (Shields DOWN)。",
    braveStep3:
      "或者：點擊 Advanced View，將 &quot;Block fingerprinting&quot; 改為 Disabled。",
    firefoxTitle: "Firefox 火狐",
    firefoxStep1:
      '點擊網址列左側的 <span class="font-bold text-purple-600">盾牌圖示</span>。',
    firefoxStep2: "關閉「增強型追蹤保護」。",
    firefoxStep3:
      "如果不想完全關閉，請至設定取消勾選「指紋追蹤器 (Fingerprinters)」。",
    safariTitle: "Safari",
  ...
  appIcon: {
    customMode: "自訂尺寸",
    appIconMode: "App 圖示",
    selectPlatform: "選擇目標平台",
    selectPlatformDesc: "勾選您需要生成圖示的平台",
    sizes: "種尺寸",
    totalOutput: "將產生",
    files: "個檔案",
    organizedIn: "分類至",
    folders: "個資料夾",
    noPlatform: "請至少選擇一個平台",
    noPlatformPreview: "請先選擇至少一個平台",
    sourceImage: "來源圖片",
    outputReadOnly: "以下為各平台輸出尺寸預覽（唯讀）",
    usage: "用途",
    status: "狀態",
    generateAndDownload: "產生並下載圖示",
    qualityHint: "此模式以 100% 最高品質輸出，不進行壓縮，確保圖示清晰銳利。",
    // iOS 描述
    descIosAppStore: "App Store 主圖標，必須不含透明度，sRGB",
    descIosIphone3x: "iPhone 主畫面 @3x",
    descIosIphone2x: "iPhone 主畫面 @2x",
    descIosIpadPro2x: "iPad Pro 主畫面 @2x",
    descIosIpad2x: "iPad 主畫面 @2x",
    descIosSettings3x: "系統設置/偏好設定 @3x",
    descIosSettings2x: "系統設置/偏好設定 @2x",
    descIosNotification3x: "通知圖標 @3x",
    descIosNotification2x: "通知圖標 @2x",
    // Android 描述
    descAndroidPlayStore: "Google Play 商店圖標，32-bit PNG，最大 1MB",
    descAndroidAdaptive: "適應性圖標 Full Asset",
    descAndroidXxxhdpi: "啟動器 xxxhdpi",
    descAndroidXxhdpi: "啟動器 xxhdpi",
    descAndroidXhdpi: "啟動器 xhdpi",
    descAndroidHdpi: "啟動器 hdpi",
    descAndroidMdpi: "啟動器 mdpi",
    descAndroidNotification: "通知圖標",
    // Web 描述
    descWebFavicon32: "瀏覽器分頁圖標",
    descWebFavicon16: "瀏覽器分頁圖標（小）",
    descWebFaviconIco: "Favicon .ico（舊版瀏覽器相容）",
    descWebAppleTouchIcon: "iOS「加到主畫面」時使用",
    descWebPwa512: "PWA 啟動閃屏用",
    descWebPwa192: "PWA 安裝圖示",
    descWebOgImage: "FB/Line 社群分享預覽圖（1.91:1）",
  },
};
